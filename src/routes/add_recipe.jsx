...
export default function AddRecipe() {
  ...
  const formSubmit = (event) => {
    ...
    const tags = Array.from(form.keys()).filter((name) =>
  ...
  return (
    <form
      className="w-3/4 mx-auto my-5 border rounded-md p-4"
      onSubmit={formSubmit}
    >
      <div className="grid grid-cols-2 grid-rows-2 gap-2">
        ...
        <Input
          id="tprepare"
          label="Time to Perpare"
          placeholder="time to preperate"
          type="number"
          name="time"
        />
        <Input
      ...
      <div className="grid grid-cols-2 gap-2">
        <div>
          <label
            htmlFor="images"
            className="border-2 border-dotted rounded-md h-32 grid items-center text-center"
          >
        ...
        <div className="border rounded-md p-2">
          {uploadedImage && (
            <img src={uploadedImage} alt="uploaded" className="rounded-md" />
          )}
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 my-2 gap-2">
        <div className="border-2 border-dashed rounded-md min-h-80">
          <div
            className="flex justify-center gap-2 m-2 border-2 p-2 rounded-md hover:cursor-pointer"
        ...
        <div className="border-2 border-dashed rounded-md min-h-80"></div>
      </div>

      <button
        type="submit"
        className="block mx-auto my-2 border rounded-md p-2  bg-blue-500 text-white w-fit"
      >
        Submit
      </button>
    </form>
